  ...
  return (
    <div className="container mx-auto max-w-screen-md px-4 py-12">
      ...
      <p className="text-lg text-muted-foreground leading-relaxed mb-10">
        Signal Archive is public-interest infrastructure for preserving and verifying public statements.
      </p>
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-3">
          <span className="text-foreground font-medium">Public-interest ranking.</span> Each
          detected deletion can receive a 1-10 review signal based on content, tweet age, and the
          account&apos;s role. Scores are indicative, not definitive. They help surface potentially
          newsworthy deletions, but they should be treated as starting points for review, not
          verdicts.
        </p>
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mt-4">
          Signal Archive publishes its authoritative Hedera topics through a public{" "}
          <Link
            href="/registry"
            className="underline underline-offset-2 hover:text-foreground"
          >
          ...
          {" "}so third parties can independently discover the archive structure without
